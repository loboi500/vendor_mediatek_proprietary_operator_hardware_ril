...
/*****************************************************************************
 * Class RtcOpSCBMController
 *****************************************************************************/

RFX_IMPLEMENT_CLASS("RtcOpSCBMController", RtcOpSCBMController, RfxController);
...
RtcOpSCBMController::RtcOpSCBMController() : m_timer(NULL) {
    setTag(String8("RtcOpSCBM"));
    logD(mTag, "RtcOpSCBMController: constructor");
}

RtcOpSCBMController::~RtcOpSCBMController() {
}

void RtcOpSCBMController::onInit() {
...
void RtcOpSCBMController::onDeinit() {
    RfxController::onDeinit();
}

bool RtcOpSCBMController::onHandleRequest(const sp<RfxMessage>& message) {
...
void RtcOpSCBMController::onTimer() {
...
bool RtcOpSCBMController::onHandleUrc(const sp<RfxMessage>& msg) {
    ...
    switch (msg_id) {
        case RFX_MSG_UNSOL_ENTER_SCBM:
            ...
            m_timer = RfxTimer::start(RfxCallback0(this, &RtcOpSCBMController::onTimer),
                    s2ns(SCM_EXIT_TIME));
            responseToRilj(msg);
            break;
